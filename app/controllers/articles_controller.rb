...
class ArticlesController < ApplicationController
  ...
  private
    ...
    def map_json_data(x)
      st = Struct.new(:id, :isbn, :title, :subtitle, :description, :price, :imponib, :imposta, :discount, :authors, :state, :d_state, :can_buy, :categories, :is_event, :pagine, :rilegatura, :width, :height, :n_pag, :dt_pub, :weight, :issuee_link, :generico, :translator, :series, :director_series, :collaborator, :youtube_presentation, :in_prenotazione)
